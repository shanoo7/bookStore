...
<div key={i} className=" border-2 border-slate-500 p-1 rounded">
          ...
          <div className="md:w-1/2 w-full flex flex-col justify-between mt-6 md:mt-0 space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button
                onClick={() => navigate(-1)}
                className="flex justify-center items-center btn-sm border btn-outline border-slate-400 text-slate-400 duration-300 min-w-24 rounded py-[18px] text-center"
              >
                Back
              </button>
            </div>
