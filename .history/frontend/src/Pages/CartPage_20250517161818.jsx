      ...
      <div className="sm:flex shadow-md border border-slate-500 my-10">
        ...
        <div className="w-full sm:w-3/4 px-10 py-10">
          ...
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item) => (
              <div key={item._id} className="md:flex items-stretch py-8 border-t-2 border-slate-500">
                <div className="md:w-4/12 w-full">
                  <img
                    src={item.image}
                    alt={item.name}
        ...
        {/* Right: Summary */}
        <div id="summary" className="w-full sm:w-1/4 md:w-1/2 px-8 py-10">
          <h1 className="font-semibold text-2xl border-b-3 border-slate-500 pb-8">Order Summary</h1>
          <div className="flex justify-between mt-10 mb-5">
            <span className="font-semibold text-sm uppercase">Items {totalItems}</span>
            <span className="font-semibold text-sm">${totalCost}</span>
          </div>
