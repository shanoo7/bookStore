    ...
    <>
      ...
      <div className='max-w-screen-2xl mx-auto'>
        <div className='pt-20  text-center'>
          <h1 className='text-2xl md:text-3xl lg:text-4xl'>We are delighted to welcome you to our
            <span className='text-pink-500 inline-flex items-center gap-2 '> Book Haven! <p><ImBook /></p></span></h1>
          <p className='my-5 text-sm md:text-xl mb-10 text-center'>
