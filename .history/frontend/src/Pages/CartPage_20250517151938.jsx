        ...
        <div className="w-full sm:w-3/4 px-10 py-10">
          ...
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item, index) => (
              <div key={item._id} className="md:flex items-stretch py-8 border-t border-gray-50">
                <div className="md:w-4/12 w-full">
                  <img
                    src={item.image}
                    alt={item.name}
          ...
          <button className="flex font-semibold text-indigo-600 text-sm mt-10">
            <svg className="fill-current mr-2 text-indigo-100 bg-slate-500 w-4" viewBox="0 0 448 512">
              <path d="M134.059 296H436c6.627 0 12-5.373..." />j
            </svg>
            Continue Shopping
          </button>
        </div>
