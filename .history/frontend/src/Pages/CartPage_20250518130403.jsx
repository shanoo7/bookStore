          ...
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item) => (
              <div key={item._id} className="md:flex items-stretch py-8 border-t border-slate-500">
                <div className="md:w-4/12 flex items-center justify-center md:justify-start w-full">
                  <img
                    src={item.image}
                    alt={item.name}
                  ...
                  <img
                    src={item.image}
                    alt={item.name}
                    className="md:hidden w-1/2 object-center"
                  />
                </div>
                ...
                <div className="md:pl-3 md:w-8/12 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-between pt-5">
                    <div className="flex items-center">
                      <p onClick={()=>toggleWishlist(item)} className="text-lg cursor-pointer"><GoHeartFill className={`${isLiked(item._id) ? " text-red-500" : ""}`}/></p>
