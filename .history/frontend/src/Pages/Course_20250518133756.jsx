  ...
  return (
    <>
      ...
      <div className='max-w-screen-2xl mx-auto'>
        <div className='pt-20 item-center  text-center'>
          <h1 className='text-sm sm:text-lg flex gap-2'>We are delighted to welcome you to our
            <span className='text-pink-500 flex'> Book Haven! <span><ImBook/></span></span></h1>
