                ...
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3 ">
                        ...
                        </div>
                        {
                            authUser ? <Logout />
                                : <div>
                                    <Link to={"/login"}> <button className='flex justify-center items-center btn-sm border btn-outline btn-error duration-300 min-w-24 rounded py-5 text-center'>Login</button></Link>
                                </div>
                        }
                    </div>
                </div>
