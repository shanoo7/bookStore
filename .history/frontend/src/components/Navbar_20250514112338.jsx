                ...
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3 ">
                        ...
                        <div className='hidden md:block'>
                            ...
                            <label className="input flex justify-center items-center gap-2 dark:bg-slate-700 dark:text-white">
                                <svg onClick={handleSearch} className="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <g
