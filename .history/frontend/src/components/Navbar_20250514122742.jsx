...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl py-3  container mx-auto  px-4 dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50  ${sticky ? " shadow-md bg-base-200 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
