...
function Cards({ item }) {
  ...
  const { handleSelectedBook, handleBuy,addToCart } = useAuth()
  return (
    <>
        ...
        <div className="card w-80 h-80  shadow-md p-3 shadow-gray-400 hover:scale-105 duration-300">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-between">
              ...
              <button onClick={() => addToCart(item)} className="badge badge-outline bg-pink-500 text-white py-4 px-2 cursor-pointer hover:bg-pink-700 duration:200">Add to cart</button>
