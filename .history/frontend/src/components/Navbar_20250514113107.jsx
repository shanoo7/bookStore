                ...
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3 ">
                        ...
                        <div className='hidden md:block'>
                            ...
                            <label className="input flex justify-center items-center gap-3 dark:bg-slate-700 dark:text-white">
                                ...
                                <input className='dark:bg-slate-600 dark:text-white' type="search" value={inputValue} required placeholder="Search" onChange={(e) => setInputValue(e.target.value)} />
                            </label>
