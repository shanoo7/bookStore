            ...
            <div className={`max-w-screen-2xl  container mx-auto  px-4 dark:bg-slate-600 dark:text-white fixed top-0 left-0 right-0 z-50  ${sticky ? " shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
                <div className="navbar">
                    <div className="navbar-start">
                        ...
                        <Link to="/" className="btn btn-ghost text-xl">  <img className='w-12 h-12' src='banner.webp' alt='Bookstore logo'></img></Link>
                    </div>
                    <div className="navbar-end space-x-3 ">
                        ...
                        <div className='hidden md:block'>
                            <label className=" flex items-center gap-2">
                                <input type="text" value={inputValue} className="grow outline-none h-14 dark:bg-slate-700 dark:text-white border px-3 py-2 rounded" placeholder="Search" onChange={(e) => setInputValue(e.target.value)} />
