...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl py-3  container mx-auto  px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50  ${sticky ? " shadow-md bg-base-300 dark:bg-gray-600 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3 ">
                        ...
                        <div className='relative text-2xl cursor-pointer'>
                            <Link to={"/cart-page"}>
                            <BsCartFill/> 
                            <span className='text-sm text-red-600 absolute -top-1 left-6'>{cartItems.length}</span>
                            </Link>
                        </div>

                        <div  className={`pl-3 text-3xl cursor-pointer ${like ? "text-red-600" :"text-white"} `}>
                            <Link onClick={()=>setLike(!like)} to={"/wishlist-page"}>
                            <BsHearts/>
                            </Link>
