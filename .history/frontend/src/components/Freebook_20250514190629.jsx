...
function Freebook() {
  ...
  const {searchTerm,category,maxPrice} = useAuth()
...
//   useEffect(()=>{
// // Filter logic
// const filteredProducts = book.filter((product) => {
//   return (
...
// setFilterBook(filteredProducts)
...
//   },[book])
  ...
  // }, [searchTerm, book,category,maxPrice]);
