...
<button onClick={()=>addToWishlist(item)}><BsHearts/></button>
              ...
              <button onClick={() =>{addToCart(item), navigate("/cart-page")}} className="badge badge-outline bg-pink-500 text-white py-4 px-2 cursor-pointer hover:bg-pink-700 duration:200">Buy Now</button>
            </div>
          </div>
        </div>
      </div>
