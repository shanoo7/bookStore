...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl py-3  container mx-auto  px-4 dark:bg-slate-600 dark:text-white fixed top-0 left-0 right-0 z-50  ${sticky ? " shadow-md bg-base-200 dark:bg-slate-700 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3 ">
                        ...
                        <div className='hidden md:block'>
                            ...
                            <label className="input border-none outline-none  flex justify-center items-center gap-3 dark:bg-slate-800 dark:text-white">
                                ...
                                <input className=' outline-none border-green-400' type="search" value={inputValue} required placeholder="Search" onChange={(e) => setInputValue(e.target.value)} />
                            </label>
