...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl py-3  container mx-auto  px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50  ${sticky ? " shadow-md bg-base-300 dark:bg-gray-800 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
...
<button
                    ...
                    <div className="navbar-end space-x-3 ">
                        ...
                        <div className="navbar-center hidden lg:flex">
                            <ul className="menu gap-3 text-white hover:text-blue-700 menu-horizontal px-5">
                                {navItems}
                            </ul>
                        </div>
