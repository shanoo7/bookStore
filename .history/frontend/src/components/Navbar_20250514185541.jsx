...
<button
                    ...
                    <div className="navbar-end bg-base-100 dark:bg-slate-600 dark:text-white space-x-3 ">
                        {/* desktop mode */}
                        <div className="navbar-center hidden lg:flex">
                            <ul className="menu gap-3 menu-horizontal px-5 bg-base-100 dark:bg-slate-200 dark:text-white">
                                {navItems}
                            </ul>
                        </div>
