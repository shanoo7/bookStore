      ...
      <div className=' w-full p-5'>
        <div className="card w-100 h-80  shadow-md p-3 shadow-gray-400 hover:scale-105 duration-300">
          ...
          <div className="card-body border">
            ...
            <div className="card-actions border items-center text-sm">
              ...
              <button onClick={() => { addToCart(item), navigate("/cart-page") }} className="badge text-sm border-none  badge-outline bg-pink-500  py-4 px-2 cursor-pointer hover:bg-pink-700 duration:200">Buy Now</button>
            </div>
          </div>
        </div>
      </div>
